...
impl<O: IsA<GutterRenderer> + IsA<glib::object::Object>> GutterRendererExt for O {
    ...
    fn begin(&self, cr: &mut cairo::Context, background_area: &mut gdk::Rectangle, cell_area: &mut gdk::Rectangle, start: &mut gtk::TextIter, end: &mut gtk::TextIter) {
        unsafe {
            ffi::gtk_source_gutter_renderer_begin(self.to_glib_none().0, cr.to_glib_none_mut().0, background_area.to_glib_none_mut().0, cell_area.to_glib_none_mut().0, start.to_glib_none_mut().0, end.to_glib_none_mut().0);
        }
    }

    fn draw(&self, cr: &mut cairo::Context, background_area: &mut gdk::Rectangle, cell_area: &mut gdk::Rectangle, start: &mut gtk::TextIter, end: &mut gtk::TextIter, state: GutterRendererState) {
        unsafe {
            ffi::gtk_source_gutter_renderer_draw(self.to_glib_none().0, cr.to_glib_none_mut().0, background_area.to_glib_none_mut().0, cell_area.to_glib_none_mut().0, start.to_glib_none_mut().0, end.to_glib_none_mut().0, state.to_glib());
        }
    }
