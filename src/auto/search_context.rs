...
pub trait SearchContextExt {
    ...
    //#[cfg(feature = "v3_10")]
    //fn backward_async<'a, 'b, P: Into<Option<&'a /*Ignored*/gio::Cancellable>>, Q: Into<Option<&'b /*Ignored*/gio::AsyncReadyCallback>>, R: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, iter: &gtk::TextIter, cancellable: P, callback: Q, user_data: R);
    ...
    //#[cfg(feature = "v3_10")]
    //fn forward_async<'a, 'b, P: Into<Option<&'a /*Ignored*/gio::Cancellable>>, Q: Into<Option<&'b /*Ignored*/gio::AsyncReadyCallback>>, R: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, iter: &gtk::TextIter, cancellable: P, callback: Q, user_data: R);
    ...
    #[cfg(feature = "v3_22")]
    fn replace2(&self, match_start: &mut gtk::TextIter, match_end: &mut gtk::TextIter, replace: &str, replace_length: i32) -> Result<(), Error>;
