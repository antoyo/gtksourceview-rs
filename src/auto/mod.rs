...
#[cfg(feature = "v3_24")]
pub use self::flags::SPACE_LOCATION_NONE;
#[cfg(feature = "v3_24")]
pub use self::flags::SPACE_LOCATION_LEADING;
#[cfg(feature = "v3_24")]
pub use self::flags::SPACE_LOCATION_INSIDE_TEXT;
#[cfg(feature = "v3_24")]
pub use self::flags::SPACE_LOCATION_TRAILING;
#[cfg(feature = "v3_24")]
pub use self::flags::SPACE_LOCATION_ALL;
#[cfg(feature = "v3_24")]
pub use self::flags::SpaceTypeFlags;
#[cfg(feature = "v3_24")]
pub use self::flags::SPACE_TYPE_NONE;
#[cfg(feature = "v3_24")]
pub use self::flags::SPACE_TYPE_SPACE;
#[cfg(feature = "v3_24")]
pub use self::flags::SPACE_TYPE_TAB;
#[cfg(feature = "v3_24")]
pub use self::flags::SPACE_TYPE_NEWLINE;
#[cfg(feature = "v3_24")]
pub use self::flags::SPACE_TYPE_NBSP;
#[cfg(feature = "v3_24")]
pub use self::flags::SPACE_TYPE_ALL;
