...
pub trait CompletionInfoExt {
    ...
    //fn move_to_iter<'a, P: IsA<gtk::TextView>, Q: Into<Option<&'a /*Ignored*/gtk::TextIter>>>(&self, view: &P, iter: Q);
...
impl<O: IsA<CompletionInfo> + IsA<glib::object::Object>> CompletionInfoExt for O {
    ...
    //fn move_to_iter<'a, P: IsA<gtk::TextView>, Q: Into<Option<&'a /*Ignored*/gtk::TextIter>>>(&self, view: &P, iter: Q) {
    //    unsafe { TODO: call ffi::gtk_source_completion_info_move_to_iter() }
    //}
