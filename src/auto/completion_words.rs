...
impl CompletionWords {
    //pub fn new<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b /*Ignored*/gdk_pixbuf::Pixbuf>>>(name: P, icon: Q) -> CompletionWords {
    //    unsafe { TODO: call ffi::gtk_source_completion_words_new() }
    //}
}
