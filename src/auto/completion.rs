...
pub trait CompletionExt {
    ...
    //fn create_context<'a, P: Into<Option<&'a /*Ignored*/gtk::TextIter>>>(&self, position: P) -> Option<CompletionContext>;
    ...
    //fn move_window(&self, iter: /*Ignored*/&mut gtk::TextIter);
...
impl<O: IsA<Completion> + IsA<glib::object::Object>> CompletionExt for O {
    ...
    //fn create_context<'a, P: Into<Option<&'a /*Ignored*/gtk::TextIter>>>(&self, position: P) -> Option<CompletionContext> {
    //    unsafe { TODO: call ffi::gtk_source_completion_create_context() }
    //}
    ...
    //fn move_window(&self, iter: /*Ignored*/&mut gtk::TextIter) {
    //    unsafe { TODO: call ffi::gtk_source_completion_move_window() }
    //}
